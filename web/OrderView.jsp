        ...
        <%
           ...
           while(rs.next()){
               if(request.getParameter(rs.getString(1))!=null && (request.getParameter(rs.getString(1)).equals("1")) || (request.getParameter("c"+rs.getString(1))!=null && request.getParameter("c"+rs.getString(1)).equals("1"))){
                   out.print("<div class='row' id='r"+rs.getString(1)+"'><br><div class='col-lg-1'><input type='text' class='sr' style='width: 50px;text-align:center' disabled></div><div class='col-lg-2'>"+rs.getString(2)+"</div><div class='col-lg-1'><input type='text' name='u"+rs.getString(1)+"' value='"+rs.getString(3)+"' style='width: 70px;text-align:center;' disabled></div>&nbsp;<div class='col-lg-2'><button class='pl' id='pl"+rs.getString(1)+"'><i class='fas fa-plus'></i></button>&nbsp;<input type='text' name='t"+rs.getString(1)+"' value='1' style='width: 50px; text-align:center' disabled>&nbsp;<button class='ms' id='m"+rs.getString(1)+"'><i class='fas fa-minus'></i></button></div><div class='col-lg-1'><input type='text' name='p"+rs.getString(1)+"' class='prc' value='"+rs.getString(3)+"' style='width: 70px; text-align: center' disabled></div><div class='col-lg-1'>Not Delieverd</div>"+"<div class='col-lg-1'><input type='checkbox' name='c"+rs.getString(1)+"' value='1' checked></div></div>");
              // k++;
               }
